...
const RegisterPage = () => {
  ...
  return (
    <section className="flex mx-2 h-[calc(100vh-220px)] flex-col items-center justify-center">
      <Link
        to="/"
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 className="text-center uppercase text-white">Registration</h1>
          <form className="space-y-4 md:space-y-6" onSubmit={registerUser}>
            ...
            <div className="relative">
              ...
              <input
                ...
                id="password"
                placeholder="••••••••"
                className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full pr-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                required
